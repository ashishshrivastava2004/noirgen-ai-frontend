...
Scene Description: ${prompt}`;
      ...
      if (!treatment) {
        return res.status(500).json({
          error: 'AI Lookbook Generation Failed: Both Gemini and Fireworks AI services failed to generate the lookbook content. Please verify your API keys are correct and active in the Secrets panel of Settings.'
        });
      }
